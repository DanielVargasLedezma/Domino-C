...
${OBJECTDIR}/c_files/Ficha.o: c_files/Ficha.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_files/Ficha.o c_files/Ficha.c
...
${OBJECTDIR}/c_files/Tablero.o: c_files/Tablero.c
	${MKDIR} -p ${OBJECTDIR}/c_files
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_files/Tablero.o c_files/Tablero.c

${OBJECTDIR}/h_files/Juego.o: h_files/Juego.c
	${MKDIR} -p ${OBJECTDIR}/h_files
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/h_files/Juego.o h_files/Juego.c
